showconsole()
mydir="./"
open(mydir .. "FEMM-2D-AS-IMSC-HMTW.FEM")
mi_saveas(mydir .. "FEMM-2D-AS-IMSC-HMTW_temp.fem")
...
--model file writing
model1_file=openfile("FEMM-2D-AS-IMSC-HMTW_three_winding_transformer_from_femm_t_model.lib","w")
write(model1_file,'.subckt FEMM-2D-AS-IMSC-HMTW_three_winding_transformer_from_femm_t_model 1 2 3 4 5 6\n')
...
write(model1_file,'.end FEMM-2D-AS-IMSC-HMTW_three_winding_transformer_from_femm_t_model \n')
